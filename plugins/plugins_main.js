...
let buttons = [{
        ...
        buttonParamsJson: JSON.stringify({
            display_text: "GITHUB",
            url: "https://github.com/BLACKY-X-MD/BLACKY-X-MD",
            merchant_url: "https://github.com/BLACKY-X-MD/BLACKY-X-MD"
            }),}]

    let message = {
                    image: LOGO,
                    header: '*BLACKY-X-MD 𝚂𝙴𝚃𝚃𝙸𝙽𝙶𝚂*',
                    footer: FOOTER,
                    body: setting
...
const msr = (await fetchJson('https://raw.githubusercontent.com/athulakumara604/BLACKY-X-MD-DATABASE/refs/heads/main/ditels/ditels.json'))
...
let repo =`
*╭──────────────●●►*
*| 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁:* 94759371545 
*| 𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳 𝚁𝙴𝙿𝙾:* https://github.com/BLACKY-X-MD/BLACKY-X-MD
*| 𝙱𝙾𝚃 𝚄𝙿𝙳𝙴𝚃𝙰 𝙽𝙴𝚆𝚂 :* https://whatsapp.com/channel/0029VawQLgP30LKW5sLcS01B/216
*╰──────────────●●►*
`
const ownerdata = (await axios.get('https://raw.githubusercontent.com/athulakumara604/BLACKY-X-MD-DATABASE/refs/heads/main/ditels/ditels.json')).data
            let LOGO = ownerdata.imageurl;
...
try{
  ...
  const msr =await fetchJson('https://raw.githubusercontent.com/athulakumara604/BLACKY-X-MD-DATABASE/refs/heads/main/Mreply.json')
...
const voice = {
    alive: 'https://github.com/athulakumara604/BLACKY-X-MD-DATABASE/raw/main/Alivevoice/0909.MP3'
}
const config = await readEnv();
