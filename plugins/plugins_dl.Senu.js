...
let desc = `
    🎟️ *BLACKY-X-MD TIKTOK DOWNLOADER* 🎟️
...
const ownerdata = (await axios.get('https://raw.githubusercontent.com/athulakumara604/BLACKY-X-MD-DATABASE/refs/heads/main/ditels/ditels.json')).data
...
await conn.sendMessage(from, { video: { url: data.data.no_wm }, mimetype: "video/mp4", caption: `> *POWERED by BLACKY-X-MD*` }, { quoted: mek })
await conn.sendMessage(from, { react: { text: '✔', key: mek.key }})
}catch(e){
await conn.sendMessage(from, { react: { text: `❌`, key: mek.key } })
console.log(e)
...
try{
  const config = await readEnv();
 const msr = (await fetchJson('https://raw.githubusercontent.com/athulakumara604/BLACKY-X-MD-DATABASE/refs/heads/main/ditels/ditels.json')).replyMsg   
if(!q) return reply(msr.url)
if (!q.includes('https://')) return await reply(msr.not_fo)
...
await conn.sendMessage(from, { react: { text: '⬆', key: mek.key }})
await conn.sendMessage(from, { video: { url: data.data.wm }, mimetype: "video/mp4", caption: `> *POWERED by BLACKY-X-MD*` }, { quoted: mek })  
await conn.sendMessage(from, { react: { text: '✔', key: mek.key }})
}catch(e){
await conn.sendMessage(from, { react: { text: `❌`, key: mek.key } })
console.log(e)
...
await conn.sendMessage(from, { react: { text: '⬆', key: mek.key }})
await conn.sendMessage(from, { video: { url: data.data.sd }, mimetype: "video/mp4", caption: `> *POWERED by BLACKY-X-MD*` }, { quoted: mek })  
await conn.sendMessage(from, { react: { text: '✔', key: mek.key }})
}catch(e){
await conn.sendMessage(from, { react: { text: `❌`, key: mek.key } })
console.log(e)
...
await conn.sendMessage(from, { react: { text: '⬆', key: mek.key }})
await conn.sendMessage(from, { video: { url: data.data.hd }, mimetype: "video/mp4", caption: `> *POWERED by BLACKY-X-MD*` }, { quoted: mek })  
await conn.sendMessage(from, { react: { text: '✔', key: mek.key }})
}catch(e){
await conn.sendMessage(from, { react: { text: `❌`, key: mek.key } })
console.log(e)
...
try{
  ...
  const config = await readEnv();
 //if (!isMe) return await reply('🚩 This command is only available to premium users. Buy Premium 94759371545')
